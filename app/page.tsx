      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex space-x-3">
            <Link 
              href="/login" 
              className="px-4 py-2 text-gray-700 rounded hover:bg-gray-500 border border-gray-300"
            >
              Login
            </Link>
            <Link 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link 
              href="/chats" 
              className="px-5 py-3 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-500 font-medium"
            >
              View Demo
            </Link>
          </div>
        ...
        <div className="flex-1 flex justify-center md:justify-end">
          <div className="w-full max-w-md bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200">
            <div className="px-4 py-3 border-b border-gray-200 flex items-center text-gray-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-800">Mobile Ready</h3>
